...
Last Contribution By: Arledge - 24-12-2023
Added filter to block Paragon by: Arledge 24-12-2023
Added Ki-rin and unicorn By: DiegoPesente 27-11-23
...
animals = {
    ...
    'a ki-rin': Animal( 'a ki-rin', 0x0084, 0x0000, 70, 80, None ),
    'a unicorn': Animal( 'a unicorn', 0x007A, 0x0000, 70, 80, None ),
...
def FindAnimalToTame():
    ...
    for tameableMobile in tameableMobiles:
        ...
        if tameableMobile.Name == tameableMobile.Name + '[Paragon]':
            tameableMobilesTemp.Remove( tameableMobile )
        ...
        if tameOngoing:
            ...
            if ( Journal.SearchByName( 'It seems to accept you as master.', animalBeingTamed.Name ) or
                ...
                if Player.Followers > numberOfFollowersToKeep:
                    ...
                    Gumps.WaitForGump( 3507367327, 1500 )
                    Gumps.SendAction( 3507367327, 2 )
                    Misc.Pause(600)
...
# Start Animal Taming
TrainAnimalTaming()
train_AnimalTaming_matsamilla.py